...
class FewdetLoss(torch.nn.Module): #TODO ADD SS LOSS AND HM LOSS
...
class FewdetTrainer(BaseTrainer): #TODO ADD SS LOSS AND HM LOSS
  def __init__(self, opt, model, optimizer=None):
    super(FewdetTrainer, self).__init__(opt, model, optimizer=optimizer)
  
  def _get_losses(self, opt):
    loss_states = ['loss', 'ss_loss', 'hm_loss', 'wh_loss', 'off_loss']
    loss = FewdetLoss(opt)
